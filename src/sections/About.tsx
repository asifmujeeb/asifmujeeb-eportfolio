...
import myImage from "@/assets/images/Asif.jpg";
...
// array of items that i am going to use in my toolbox below
const toolBoxItems = [
  {
    title: "JavaScript",
        ...
        <div className="mt-20 flex flex-col gap-8">
          <div className="grid grid-cols-1 gap-8 md:grid-cols-5 lg:grid-cols-3">
            ...
            <Card className="h-[320px] md:col-span-2 lg:col-span-1">
              <CardHeader
                title="My Profile"
                description="Aspiring Frontend Developer | Kitchener, Ontario"
              />
              <div className="w-40 mx-auto mt-2 md:mt-0 ">
                <Image src={myImage} alt="profile Image" />
              </div>
            </Card>
            {/* toolbox section */}
            <Card className="h-[320px] md:col-span-3 lg:col-span-2">
              ...
              <ToolboxItems
                items={toolBoxItems}
                className="mt-6"
                itemsWrapperClassName="-translate-x-1/2 move-right"
              />
            </Card>
          </div>
