      ...
      <div className="container">
        ...
        <div className="max-w-lg mx-auto">
          ...
          <p className="mt-4 text-center text-white/60 md:text-lg">
            ...
            high-performing, functional web applications. import memojiImage from "@/assets/images/memoji-computer-1.png";
import Image from "next/image";
import ArrowDown from "@/assets/icons/arrow-down.svg";
import grainImage from "@/assets/images/grain.jpg";
import StarIcon from "@/assets/icons/star.svg";
    ...
    >
      ...
      <div className="container">
        ...
        <div className="max-w-lg mx-auto">
          ...
          <p className="mt-4 text-center text-white/60 md:text-lg">
            I specialize in bringing designs to life by creating
            high-performing, functional web applications. Let&rsquo;s collaborate and
